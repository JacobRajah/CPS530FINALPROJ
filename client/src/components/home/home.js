...
{    
    return(
        <div className="homepage">
            ...
            <h2 className="h2-p1">FrontEnd Language: React.js</h2>
            <figure>
            <img className="img-p1" src={React} alt="React Symbol"></img>
            <figcaption className="figcaption-p1"> Figure 1. React.js</figcaption>
            </figure>
            <h3 className="h3-p1">Popularity</h3>
            <p className="para">React is a JavaScript library that specializes in helping developers build user interfaces, or UIs.
            ...
            <h3 className="h3-p1">Strengths</h3>
            <ul className="para">
            ...
            <h3 className="h3-p1">Weaknesses</h3>
            <ul className="para">
            ...
            <h2 className="h2-p1">Backend Language: Express.js</h2>
            <figure>
            <img className="img-p1" src={Express} alt="Express Symbol"></img>
            <figcaption className="figcaption-p1"> Figure 2. Express.js</figcaption>
            </figure>
            <h3 className="h3-p1">Popularity</h3>
            <p className="para">Express js is a backend development framework for Node js. The Language is
